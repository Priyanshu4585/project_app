  ...
  return (
    <Layout>
      <div className="cart-page mb-5">
        <div className="row">
          <div className="col-md-12" style={{backgroundImage: "url('/images/banner.png')", height: "250px"}}>
            <h1 className="text-center p-5 mb-1 " >
              {!auth?.user
                ? "Hello Guest"
              ...
              {auth?.user?.address ? (
                <>
                  <div className="mb-3">
                    ...
                    <h5><strong></strong>{auth?.user?.address}</h5>
                    <button
                      className="green"
